...
### data: 23/03/2020
### Description: This script creates a data table containing the density or abundance of each life form by subplots and plots. It also create an errorbar graphic to density of each life form by time.   
...
tree <- ggplot(arvores, aes(time, abundances, color = Treatment)) +
  ...
  expand_limits(y=2.5) +
  scale_x_discrete(labels = c("01","06","12","18","24","30","36","42","48","54","60","66","72","78","84","90","96"))
tree

ggsave("C:/Users/Yuri/Google Drive/Yuri/Mestrado/parcelas_biota/projeto/PPG/tese/analises/02_figuras/abundance/ribbon_line_trees_abundance_month.png", w = 20, h = 10, units = "cm", dpi = 300)
...
palm <- ggplot(palmeiras, aes(time, abundances, color = Treatment)) +
  ...
  annotate("text", label = 'atop(bold("B"))', parse= TRUE, size = 7, x = 17.3, y = 12.5) +
...
ggsave("C:/Users/Yuri/Google Drive/Yuri/Mestrado/parcelas_biota/projeto/PPG/tese/analises/02_figuras/abundance/ribbon_line_palm_abundance_month.png", w = 20, h = 10, units = "cm", dpi = 300)
...
liana <- ggplot(lianas, aes(time, abundances, color = Treatment)) +
  ...
  annotate("text", label = 'atop(bold("C"))', parse= TRUE, size = 7, x = 1, y = 10) +
  #    annotate("text", label = "2009", size = 3, x = 1, y = 1.866) +
  #   annotate("text", label = "2010", size = 3, x = 3, y = 1.71) +
  #  annotate("text", label = "2011", size = 3, x = 5, y = 1.789) +
  # annotate("text", label = "2012", size = 3, x = 7, y = 1.97) +
...
ggsave("C:/Users/Yuri/Google Drive/Yuri/Mestrado/parcelas_biota/projeto/PPG/tese/analises/02_figuras/abundance/ribbon_line_lianas_abundance_month.png", w = 20, h = 10, units = "cm", dpi = 300)
...
shrub <- ggplot(arbusto, aes(time, abundances, color = Treatment)) +
  ...
  annotate("text", label = 'atop(bold("D"))', parse= TRUE, size = 7, x = 17.3, y = 7.9) +
  #    annotate("text", label = "2009", size = 3, x = 1, y = 1.866) +
  #   annotate("text", label = "2010", size = 3, x = 3, y = 1.71) +
  #  annotate("text", label = "2011", size = 3, x = 5, y = 1.789) +
  # annotate("text", label = "2012", size = 3, x = 7, y = 1.97) +
...
ggsave("C:/Users/Yuri/Google Drive/Yuri/Mestrado/parcelas_biota/projeto/PPG/tese/analises/02_figuras/abundance/ribbon_line_shrubs_abundance_month.png", w = 20, h = 10, units = "cm", dpi = 300)
...
herb <- ggplot(ervas, aes(time, abundances, color = Treatment)) +
  ...
  annotate("text", label = 'atop(bold("E"))', parse= TRUE, size = 7, x = 1, y = 14) +
  #    annotate("text", label = "2009", size = 3, x = 1, y = 1.866) +
  #   annotate("text", label = "2010", size = 3, x = 3, y = 1.71) +
  #  annotate("text", label = "2011", size = 3, x = 5, y = 1.789) +
  # annotate("text", label = "2012", size = 3, x = 7, y = 1.97) +
...
ggsave("C:/Users/Yuri/Google Drive/Yuri/Mestrado/parcelas_biota/projeto/PPG/tese/analises/02_figuras/abundance/ribbon_line_herb_abundance_month.png", w = 20, h = 10, units = "cm", dpi = 300)
...
bamboo <- ggplot(bamboos, aes(time, abundances, color = Treatment)) +
  ...
  annotate("text", label = 'atop(bold("F"))', parse= TRUE, size = 7, x = 17.3, y = 5.7) +
  #    annotate("text", label = "2009", size = 3, x = 1, y = 1.866) +
  #   annotate("text", label = "2010", size = 3, x = 3, y = 1.71) +
  #  annotate("text", label = "2011", size = 3, x = 5, y = 1.789) +
  # annotate("text", label = "2012", size = 3, x = 7, y = 1.97) +
...
ggsave("C:/Users/Yuri/Google Drive/Yuri/Mestrado/parcelas_biota/projeto/PPG/tese/analises/02_figuras/abundance/ribbon_line_bamboos_abundance_month.png", w = 20, h = 10, units = "cm", dpi = 300)
...
ggsave("C:/Users/Yuri/Google Drive/Yuri/Mestrado/parcelas_biota/projeto/PPG/tese/analises/02_figuras/abundance/all_life_forms_abundance_month.png", w = 40, h = 35, units = "cm", dpi = 300)
