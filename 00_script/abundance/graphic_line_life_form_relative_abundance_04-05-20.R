...
ggplot(rel.abun, aes(x = time, y = rel.abun, group = life_form, color = life_form)) + 
  geom_line(size = 1) + 
  theme_bw() + 
  facet_grid(Treatment~., space="free") +
  scale_y_continuous(labels = scales::percent_format(accuracy = 2)) + 
  labs(y = "Relative abundance", x = "Months", color = "Life-forms") +
...
ggsave("C:/Users/Yuri/Google Drive/Yuri/Mestrado/parcelas_biota/projeto/PPG/tese/analises/02_figuras/relative_abundance/lines_relative_abun_lf_facetwrap_04-05-20.jpeg", width = 25, height = 15, units = "cm", dpi = 300)
