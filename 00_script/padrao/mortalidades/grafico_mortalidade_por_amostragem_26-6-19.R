...
ttlplt <- read_csv("mortalidade_por_amostragem_26-09-19.csv")
...
ggplot(ttlplt, aes(x=Period, y=Freq, fill = Tratment)) + 
  ...
  labs(x = "Time (month)", y = "Seedlings mortality")

ggsave("C:/Users/Yuri/Google Drive/Yuri/Mestrado/parcelas_biota/projeto/PPG/tese/analises/02_figuras/padrao/mortality_year.JPEG", he = 15, wi = 20, un = "cm", dpi = 300)
